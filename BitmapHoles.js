...
// which will be a 2D matrix of 0 and 1's, and determine how many holes, or contiguous
// regions of 0's, exist in the matrix. A contiguous region is one where
// there is a connected group of 0's going in one or more of four directions:
...
// For the input above, your program should return 2
// because there are two separate contiguous
// regions of 0's, which create "holes" in the matrix.
...
// Connected-component labeling на русском
...
const BitmapHoles = (strArr) => {
  ...
  strArr.forEach((element) => {
    arr.push(reduce(element));
  });

  return arr;
};

console.log(BitmapHoles(input));
